...
<nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php" style="font-size: 18px;">BANGLADESH BANK</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="employee/change_pin.php"><i class="material-icons">lock</i>change password</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="employee/change_pin_user.php">
...
<section class="content" id="top">
       <div class="container-fluid">
            <div class="block-header">
                <div  class="col-sm-8">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">Account History Board</p>
            </div>
            </div>
              <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
                     ...
                     if($_GET['id']==""){
                     ?>
                   <p style="text-align: left; font-weight: bold;">Account Number</p>
              <form id="form" method = "post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div  class="col-sm-2">
                        <input type="submit"  class="btn btn-primary form-control" style=" font-size: 17px; width: 120px; border-radius: 5px;" name="filter" id="sbtn" value="Submit">
                       </div>
                    </div>
                </form>
                <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
            ...
            <br>
                ...
                <?php
                    if (isset($_POST['filter'])) {
                      ...
                      $sql="SELECT c.* , p.* FROM accountsholder c,account_history p WHERE c.account=p.account and p.account='$sender' and c.email='$newemail' ORDER BY p.no DESC";
                  ...
                  $sql2="SELECT account
                  FROM accountsholder
                  WHERE accountsholder.account ='$sender' AND accountsholder.email='$newemail'";
                  $nm1= (mysqli_query($con,$sql2));

                  if(mysqli_num_rows($nm1)>0){
                   
                  $sql2="SELECT *  FROM accounts_info  where 
                  accounts_info.account='$sender'";
                  $newresult=(mysqli_query($con,$sql2));
                  $balance=mysqli_fetch_array ($newresult);
                  }
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div ><h4 style="margin-top: 5px; font-size: 20px;"><?php echo $balance['balance']?>Tk</h4></div>
                        </div>
                  </div>
            </div>
...
<br><br><br><br><br><br>
<div class="row clearfix" style="margin-top: 34rem;" id="not">
    <div class="footer-basic" style="background:#2196F3"  id="bot">
        <footer>
          ...
          <hr style="height:1px;border-width:0; margin-top: -10px; color:gray;background-color:gray">
            ...
            <p class="copyright" style="margin-top: 0px;">BANGLADESH BANK</p>
        </footer>
    </div>
</div>
</section>
    ...
    <?php 
                  ...
                  if($_SESSION['type']=="Admin" || $_SESSION['type']=="Employee"){
                   ?>
                    ...
                    <table class="display table table-bordered" id="myTable" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                           ...
                           <td style="text-align: center;"><?php echo $row['amount'].".00TK";?></td>
